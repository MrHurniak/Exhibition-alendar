...
<head>
    ...
    <link rel="icon" type="image/png" href="img/paint-board-and-brush.png" sizes="96x96">
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark" style="justify-content: space-between;">
        <a class="navbar-brand " href="#">
            <img src="img/paint-board-and-brush.svg" class="mx-5" alt="Logo" style="width:40px;">
            Logo of project
        </a>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a href="expositions.html" class="nav-link">Exhibitions</a>
                </li>
                <li class="nav-item">
        ...
        <div class="container">
            <div class="row  justify-content-center">
                <div class="col-xs-12 col-sm-10 p-2" style="border-left: 1px solid grey; border-right: 1px solid grey;">
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner my-3">
                            <div class="carousel-item active">
                                <img class="d-block w-100"  src="img/dobro.jpg" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="img/dobro.jpg" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="img/dobro.jpg" alt="Third slide">
                            </div>
                        </div>
                    ...
                    <img src="img/cartinca.jpg" style="float: left;  height: 300px;" class="m-3" alt="">
