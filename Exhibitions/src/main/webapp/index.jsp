        ...
        <div class="container">
            <div class="row  justify-content-center">
                <div class="col-xs-12 col-sm-10 p-2" style="border-left: 1px solid grey; border-right: 1px solid grey;">
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner my-3" style="height: 300px; width: 100%">
                            ...
                            <div class="carousel-item">
                                <img class="slide-img" src="${pageContext.request.contextPath}/img/expo2.jpg" alt="Second slide">
                            ...
                            <div class="carousel-item">
                                <img class="slide-img" src="${pageContext.request.contextPath}/img/expo3.jpg" alt="Third slide">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5>Третій слайд</h5>
                    ...
                    <h3 style="clear: left;"><fmt:message key="index.map.find.us" bundle="${link}"/></h3>
